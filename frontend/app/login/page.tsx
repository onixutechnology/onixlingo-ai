      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-500 delay-150">
        <div className="bg-[#0F1623]/80 backdrop-blur-xl py-8 px-6 shadow-2xl border border-slate-800/60 rounded-3xl sm:px-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-3.5 border border-slate-700 rounded-xl bg-[#0B0F19]/50 text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all sm:text-sm disabled:opacity-50"
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-12 py-3.5 border border-slate-700 rounded-xl bg-[#0B0F19]/50 text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all sm:text-sm disabled:opacity-50"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            {/* ALERTA DE ERROR */}
            {status === 'error' && (
              <div className="flex items-start gap-3 text-red-400 bg-red-400/5 p-4 rounded-xl border border-red-400/20 text-sm animate-in shake">
            ...
            <button
              ...
              className={`w-full flex justify-center items-center gap-2 py-3.5 px-4 rounded-xl shadow-lg text-sm font-bold text-white transition-all group disabled:cursor-not-allowed
                ${status === 'success' ? 'bg-emerald-500 hover:bg-emerald-500 shadow-emerald-500/20' : 'bg-indigo-600 hover:bg-indigo-500 shadow-indigo-600/20 active:scale-[0.98]'}
              `}
            >
              {status === 'loading' ? (
