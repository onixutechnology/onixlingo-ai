...
export default function RefundsPage() {
  return (
    <div className="prose prose-invert max-w-none text-slate-700">
      <h2 className="text-3xl font-black mb-6 text-slate-900 font-serif italic">Política de Cancelación y Reembolsos</h2>
      ...
      <h3 className="text-xl font-bold mt-8 mb-4 text-[#D4AF37]">1. Cancelación de Suscripciones</h3>
      ...
      <h3 className="text-xl font-bold mt-8 mb-4 text-[#D4AF37]">2. Política de Reembolso — 14 Días</h3>
      ...
      <h3 className="text-xl font-bold mt-8 mb-4 text-[#D4AF37]">3. Cómo Solicitar un Reembolso</h3>
      <p className="mb-4 leading-relaxed">
      ...
      <h3 className="text-xl font-bold mt-8 mb-4 text-[#D4AF37]">4. Gestión de Devoluciones a través de Paddle</h3>
      <div className="bg-[#D4AF37]/10 p-6 rounded-none border border-[#D4AF37]/30 text-slate-900 font-medium my-6">
        <p className="mb-3">
      ...
      <h3 className="text-xl font-bold mt-8 mb-4 text-[#D4AF37]">5. Disputas de Pago</h3>
      <p className="mb-4 leading-relaxed">
