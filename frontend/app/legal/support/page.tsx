...
export default function SupportPage() {
  return (
    <div className="prose prose-invert max-w-none text-slate-700">
      <h2 className="text-3xl font-black mb-6 text-slate-900 font-serif italic">Soporte y Contacto</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div className="bg-[#D4AF37]/10 p-6 rounded-none border border-[#D4AF37]/30 flex flex-col justify-between">
          <div>
            <div className="w-10 h-10 bg-[#D4AF37]/20 text-[#D4AF37] flex items-center justify-center rounded-none mb-4">
              <Mail size={20} />
            </div>
          ...
          <span className="text-sm font-bold text-[#D4AF37]">soporte@onixu.company</span>
        </div>
        ...
        <div className="bg-[#D4AF37]/10 p-6 rounded-none border border-[#D4AF37]/30 flex flex-col justify-between">
          ...
          <span className="text-sm font-bold text-[#D4AF37]">24 a 48 horas hábiles</span>
        </div>
      </div>

      <h3 className="text-xl font-bold mt-8 mb-4 text-[#D4AF37]">Preguntas Frecuentes de Soporte</h3>
      ...
      <div className="space-y-6 mt-6">
        ...
        <div className="pb-4">
          <h4 className="text-base font-bold text-slate-900 flex items-center gap-2">
            <ShieldAlert size={16} className="text-[#D4AF37] shrink-0" />
