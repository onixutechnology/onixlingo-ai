  ...
  return (
    <form className="space-y-4" onSubmit={handleRegister}>
      ...
      <div>
        ...
        <p className="mt-1.5 text-[8px] font-black text-slate-400 uppercase tracking-[0.15em] leading-normal text-center">
      ...
      <button
        type="submit"
        disabled={status === 'loading'}
        className="w-full flex justify-center items-center gap-2 py-3.5 px-4 rounded-none text-[9px] font-black uppercase tracking-[0.2em] text-white bg-slate-900 hover:bg-teal-650 active:scale-95 shadow-md shadow-slate-900/10 transition-all disabled:cursor-not-allowed"
      >
        {status === 'loading' ? (
