    ...
    <div className="w-full max-w-[1800px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 bg-slate-900 bg-gradient-to-r from-slate-900 via-indigo-900 to-slate-900 p-6 md:p-8 border border-[#1d4ed8]  relative overflow-hidden group">
        ...
        <div className="relative z-10 flex items-center gap-5">
          ...
          <div>
            <h2 className="text-2xl font-black text-white tracking-widest uppercase text-">Motores de Sistema</h2>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        {configs.map((config, idx) => (
          <div key={config.id} className="bg-white border border-[#1d4ed8]   transition-shadow flex flex-col relative overflow-hidden group">
              ...
              <div className="space-y-5 flex-1">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full p-2 border border-[#1d4ed8] text-sm font-medium focus:border-[#1d4ed8] outline-none bg-slate-50 focus:bg-white"
                  >
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <textarea 
                    ...
                    className="w-full p-3 border border-[#1d4ed8] text-sm focus:border-[#1d4ed8] outline-none bg-slate-50 focus:bg-white resize-none flex-1 min-h-[150px] font-mono leading-relaxed"
                  />
                </div>
              </div>
