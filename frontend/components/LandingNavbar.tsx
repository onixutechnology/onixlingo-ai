      ...
      <div className="fixed top-0 left-0 w-full flex justify-center z-50">
        ...
        >
          <div className="w-full px-6 lg:px-12 h-20 flex items-center justify-between">
            ...
            {/* ENLACES (Centro) */}
            <div className="hidden lg:flex flex-none justify-center gap-6 xl:gap-10 items-center text-xs xl:text-sm font-bold text-slate-900/90 uppercase tracking-[0.2em] whitespace-nowrap">
            ...
            <div className="flex-1 flex justify-end items-center gap-4 xl:gap-6">
              ...
              <Link href="/register" className="hidden sm:block">
                <button className="bg-white hover:bg-white text-black border border-white text-xs xl:text-sm font-bold py-2 xl:py-2.5 px-6 xl:px-8 rounded-none transition-all shadow-none hover:shadow-none hover:scale-105 active:scale-95 uppercase tracking-[0.2em] whitespace-nowrap">
                  Crear Cuenta
                </button>
              </Link>
              {/* Botón menú móvil */}
              <button className="lg:hidden p-2 text-slate-900 ml-2" onClick={() => setIsMenuOpen(!isMenuOpen)}>
