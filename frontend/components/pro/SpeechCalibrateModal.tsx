...
const CALIBRATION_PHRASES: CalibrationPhrase[] = [
  ...
  { id: 'c2_04', level: 'C2', category: 'Innovation Keynote', focus: 'Inspirational flow', targetWPM: [120, 150], text: 'We are architecting a tech-native ecosystem wherein autonomous decision engines accelerate institutional cognition while preserving human judgment at critical governance inflection points.' },
