...
def create_db():
    ...
    from app.db.models import User, Progress, UserAchievement, ChessLesson, ChessProgress, ChessMatch, ChessMove, PromoCoupon, BetaCode, SpeechPracticeLog, ExamAttempt
