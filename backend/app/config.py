...
class Settings(BaseSettings):
    ...
    # 🚀 ACTUALIZADO: URL para redirigir al usuario tras el pago
    FRONTEND_URL: str = os.getenv("FRONTEND_URL", "https://onixlingo.onixu.company") 

    # --- CORS (DOMINIOS PERMITIDOS) ---
    # 🚀 LA SOLUCIÓN AL ERROR: Lista de dominios que pueden hablar con el backend
    BACKEND_CORS_ORIGINS: List[str] = [
        ...
        "https://www.onixlingo.onixu.company"   # Tu dominio oficial con www
    ]
